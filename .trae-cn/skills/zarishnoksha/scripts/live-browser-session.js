/**
 * Browser-side durable session helpers for zarishnoksha live mode.
 *
 ...
 * window.__zarishnoksha_LIVE_SESSION__.
 */
((root) => {
  ...
  root.__zarishnoksha_LIVE_SESSION__ = { createLiveBrowserSessionState };
