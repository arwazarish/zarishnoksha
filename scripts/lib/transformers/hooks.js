/**
 * Build-pipeline emitters for the zarishnoksha design hook.
 *
 * Two emission targets exist:
 *
 * 1. Project-local install (the `npx zarishnoksha skills install` CLI path):
 ...
 * root rather than assuming a `.claude/skills/zarishnoksha/` layout, so it stays
 * correct wherever Claude Code unpacks the plugin.
 */

export const zarishnoksha_HOOK_COMMAND_MARKER = "skills/zarishnoksha/scripts/hook.mjs";

const TIMEOUT_SECONDS = 5;
const STATUS_MESSAGE = "Checking UI changes";
const CLAUDE_PROJECT_HOOK = "${CLAUDE_PROJECT_DIR}/.claude/skills/zarishnoksha/scripts/hook.mjs";
const CLAUDE_PLUGIN_HOOK = "${CLAUDE_PLUGIN_ROOT}/skills/zarishnoksha/scripts/hook.mjs";
const CODEX_PROJECT_HOOK = "$(git rev-parse --show-toplevel)/.agents/skills/zarishnoksha/scripts/hook.mjs";
const CURSOR_BEFORE_EDIT_SCRIPT = ".cursor/skills/zarishnoksha/scripts/hook-before-edit.mjs";
const GITHUB_PROJECT_HOOK = "$(git rev-parse --show-toplevel)/.github/skills/zarishnoksha/scripts/hook.mjs";
