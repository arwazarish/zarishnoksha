...
<body>
  ...
  <div class="stage">
    <div class="brand">
      ...
      <span class="wordmark">ZarishNoksha</span>
    </div>
    <div class="headline-wrap">
      <h1 class="headline">Give your agent a<br>designer&rsquo;s vocabulary.</h1>
      <p class="sub">Stop shipping generic frontend. A design skill, CLI, and browser extension for the tools you already build with.</p>
    </div>
    <div class="meta">
      ...
      <div class="domain">zarishnoksha.pages.dev</div>
    </div>
  </div>
</body>
</html>`;
  ...
  const tmpHtml = path.join(os.tmpdir(), `zarishnoksha-og-${process.pid}.html`);
