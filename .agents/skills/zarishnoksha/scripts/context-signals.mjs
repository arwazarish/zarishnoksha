...
/**
 * Context-signals gatherer for the bare `{{command_prefix}}zarishnoksha`
 ...
 * light: no LLM calls, no detector run (`npx zarishnoksha detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.zarishnoksha/critique)
