/**
 * Framework-neutral zarishnoksha live chrome contract.
 *
...
export const LIVE_UI_SURFACES = Object.freeze([
  {
    ...
    ids: [
      "zarishnoksha-live-global-bar",
      "zarishnoksha-live-global-bar-brand",
      "zarishnoksha-live-pick-toggle",
      "zarishnoksha-live-insert-toggle",
      "zarishnoksha-live-detect-toggle",
      "zarishnoksha-live-detect-badge",
      "zarishnoksha-live-design-toggle",
      "zarishnoksha-live-page-chat",
      "zarishnoksha-live-page-chat-input",
  ...
  },
  {
    ...
    ids: ["zarishnoksha-live-pending-dock"],
    states: ["closed", "open", "hover", "pressed", "loading", "rollback", "keep-fixing"],
  },
  {
    key: "element-selection-chrome",
    ids: [
      "zarishnoksha-live-highlight",
      "zarishnoksha-live-tooltip",
      "zarishnoksha-live-bar",
      "zarishnoksha-live-selection-pill",
      "zarishnoksha-live-input",
      "zarishnoksha-live-configure-voice",
      "zarishnoksha-live-configure-bar-tooltip",
    ],
    states: ["rest", "hover", "focus-visible", "pressed", "disabled"],
  },
  {
    key: "action-picker",
    ids: ["zarishnoksha-live-picker"],
    states: ["closed", "open", "option-hover", "option-focus"],
  },
  {
    key: "edit-chrome",
    ids: ["zarishnoksha-live-edit-badge"],
    states: ["enabled", "disabled", "editing", "cancel", "save", "edited-content"],
  },
  {
    key: "generating-row",
    ids: ["zarishnoksha-live-bar", "zarishnoksha-live-shader"],
    states: ["action-label", "animated-dots", "generating", "done"],
  },
  {
    key: "variant-cycling-row",
    ids: ["zarishnoksha-live-bar", "zarishnoksha-live-params-panel"],
    states: [
      "variant-1",
      "variant-2",
      "variant-3",
  ...
  },
  {
    ...
    ids: ["zarishnoksha-live-params-panel"],
    states: ["closed", "open-above", "open-below", "range", "steps", "toggle"],
  },
  {
    key: "saving-confirmed-rows",
    ids: ["zarishnoksha-live-bar"],
    states: ["saving", "applying-variant", "confirmed"],
  },
  {
    key: "insert-mode-chrome",
    ids: [
      "zarishnoksha-live-insert-line",
      "zarishnoksha-live-insert-placeholder",
      "zarishnoksha-live-placeholder-resize",
      "zarishnoksha-live-insert-input",
      "zarishnoksha-live-insert-voice",
      "zarishnoksha-live-insert-create",
      "zarishnoksha-live-insert-create-tooltip",
    ],
  ...
  },
  {
    ...
    ids: [
      "zarishnoksha-live-annot",
      "zarishnoksha-live-annot-svg",
      "zarishnoksha-live-annot-pins",
      "zarishnoksha-live-annot-clear",
    ],
    states: ["overlay", "drawing", "pin", "pin-edit", "clear"],
  },
  {
    key: "design-system-panel",
    ids: ["zarishnoksha-live-design-host"],
    states: ["closed", "open", "tabs", "token-tiles", "copy"],
  },
  {
    key: "toasts-and-errors",
    ids: ["zarishnoksha-live-toast"],
    states: ["normal", "error", "no-variants-mounted"],
  },
  {
    key: "css-isolation-boundary",
    ids: ["zarishnoksha-live-root"],
...
export function resolveLiveUiRoot(env = globalThis) {
  ...
  const explicit = env?.__zarishnoksha_LIVE_UI_ROOT__ || env?.window?.__zarishnoksha_LIVE_UI_ROOT__;
...
export function appendToLiveUiRoot(el, env = globalThis) {
  const root = resolveLiveUiRoot(env);
  if (!root) throw new Error("zarishnoksha live UI root is not available");
  root.appendChild(el);
  return el;
}
