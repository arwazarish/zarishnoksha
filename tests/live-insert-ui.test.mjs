...
describe("insertCreateDisabledReason", () => {
  ...
  it("explains why Create is disabled", () => {
    assert.match(insertCreateDisabledReason({ prompt: "", comments: [], strokes: [] }), /prompt or annotate/i);
  });
});
...
describe("placeholderSizing", () => {
  ...
  it("uses auto width for row-axis grid inserts", () => {
    assert.deepEqual(placeholderSizing({ axis: "row", parentDisplay: "grid", parentWidth: 500, anchorFlex: "none" }), {
      kind: "auto",
    });
  });
