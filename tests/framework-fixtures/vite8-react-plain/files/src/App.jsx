  ...
  return (
    <main className="page">
      ...
      <section className="capacity-panel" aria-label="Workshop capacity">
        ...
        <span className="capacity-check" hidden>
      ...
      <section className="large-manual-grid" aria-label="Large manual edit batch">
        {largeManualItems.map((item) => (
          <span className="large-manual-item" key={item.label}>
            {item.label}
          </span>
        ))}
      </section>
      ...
      <section className="action-row" aria-label="Workshop actions">
        <span className="primary-action" role="button" tabIndex="0">
          Learn more
        </span>
        <span className="secondary-action" role="button" tabIndex="0">
          Learn more
        </span>
      </section>
    </main>
