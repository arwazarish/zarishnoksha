...
import { buildSupabaseRemotePatterns, createBaseNextConfig } from "@app/shared/next-config";
...
const baseConfig = createBaseNextConfig({
  ...
  additionalScriptSrc: [posthogHost, ...__zarishnokshaLiveDev],
  additionalConnectSrc: [posthogHost, ...__zarishnokshaLiveDev],
});
