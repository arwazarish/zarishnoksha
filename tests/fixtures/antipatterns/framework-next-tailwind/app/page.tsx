  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:text-left">
        ...
        <p className="text-gray-400 text-lg mb-12">The next generation of web development</p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FeatureCard title="Fast" description="Lightning-fast performance out of the box" icon="⚡" />
          <FeatureCard title="Scalable" description="Grows with your business needs" icon="📈" />
          <FeatureCard title="Secure" description="Enterprise-grade security built in" icon="🔒" />
        </div>
