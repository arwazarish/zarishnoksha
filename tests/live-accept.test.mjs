...
describe("live-accept — style-element edge cases", () => {
  let tmp;
  beforeEach(() => {
    tmp = mkdtempSync(join(tmpdir(), "zarishnoksha-accept-test-"));
  });
  afterEach(() => {
  ...
  // separate closer, so it got stuck forever and missed data-zarishnoksha-variant
  // divs that came after.
  it("finds the accepted variant after a JSX self-closing <style /> block", () => {
    const html = `<body>
  <!-- zarishnoksha-variants-start SELFC -->
  <div data-zarishnoksha-variants="SELFC" data-zarishnoksha-variant-count="3" style="display: contents">
    <div data-zarishnoksha-variant="original">
      <p class="hook">original text</p>
    </div>
    <style data-zarishnoksha-css="SELFC" dangerouslySetInnerHTML={{ __html: '@scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }' }} />
  ...
  <!-- zarishnoksha-variants-end SELFC -->
</body>`;
    ...
    // no carbonize block, no data-zarishnoksha-variant wrapper (it would serve no purpose).
    assert.ok(!after.includes("zarishnoksha-carbonize-start"), "no carbonize block (self-closing style has no body)");
    assert.ok(!after.includes("zarishnoksha-variants-start"), "variant markers removed");
  ...
  it("finds the accepted variant after a single-line <style>…</style> block", () => {
    const html = `<body>
  <!-- zarishnoksha-variants-start ONELINE -->
  <div data-zarishnoksha-variants="ONELINE" data-zarishnoksha-variant-count="3" style="display: contents">
    <div data-zarishnoksha-variant="original"><p class="hook">original</p></div>
    <style data-zarishnoksha-css="ONELINE">@scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }</style>
    <div data-zarishnoksha-variant="1"><p class="hook">variant one</p></div>
    <div data-zarishnoksha-variant="2" style="display: none"><p class="hook">variant two</p></div>
    <div data-zarishnoksha-variant="3" style="display: none"><p class="hook">variant three</p></div>
  </div>
  <!-- zarishnoksha-variants-end ONELINE -->
</body>`;
    writeFileSync(join(tmp, "page.html"), html);
    ...
    const after = readFileSync(join(tmp, "page.html"), "utf-8");
    assert.ok(after.includes('data-zarishnoksha-variant="3"'), "accepted wrapper for variant 3 present");
  ...
  it("finds the accepted variant after a multi-line <style>…</style> block (regression baseline)", () => {
    const html = `<body>
  <!-- zarishnoksha-variants-start MULTI -->
  <div data-zarishnoksha-variants="MULTI" data-zarishnoksha-variant-count="3" style="display: contents">
    <div data-zarishnoksha-variant="original"><p class="hook">original</p></div>
    <style data-zarishnoksha-css="MULTI">
      @scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }
      @scope ([data-zarishnoksha-variant="2"]) { .hook { color: green; } }
    </style>
    <div data-zarishnoksha-variant="1"><p class="hook">variant one</p></div>
    <div data-zarishnoksha-variant="2" style="display: none"><p class="hook">variant two</p></div>
  </div>
  <!-- zarishnoksha-variants-end MULTI -->
</body>`;
    writeFileSync(join(tmp, "page.html"), html);
    ...
    const after = readFileSync(join(tmp, "page.html"), "utf-8");
    assert.ok(after.includes('data-zarishnoksha-variant="1"'), "accepted wrapper for variant 1 present");
  ...
  it("carbonize does not double-wrap when the variants block uses JSX template literals on their own lines", () => {
    const tsx =
      ...
      `    <main>\n` +
      `      <>\n` +
      `        {/* zarishnoksha-variants-start TPL */}\n` +
      `        <div data-zarishnoksha-variants="TPL" data-zarishnoksha-variant-count="2" style={{ display: 'contents' }}>\n` +
      `          <div data-zarishnoksha-variant="original"><p className="hook">orig</p></div>\n` +
      `          <style data-zarishnoksha-css="TPL">\n` +
      "            {`\n" +
      `              @scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }\n` +
      `              @scope ([data-zarishnoksha-variant="2"]) { .hook { color: green; } }\n` +
      "            `}\n" +
      `          </style>\n` +
      `          <div data-zarishnoksha-variant="1"><p className="hook">variant one</p></div>\n` +
      `          <div data-zarishnoksha-variant="2" style={{ display: 'none' }}><p className="hook">variant two</p></div>\n` +
      `        </div>\n` +
      `        {/* zarishnoksha-variants-end TPL */}\n` +
      `      </>\n` +
      `    </main>\n` +
      `  );\n` +
      `}\n`;
    ...
    const carbonStyleMatch = after.match(/<style data-zarishnoksha-css="TPL">([\s\S]*?)<\/style>/);
    ...
    assert.ok(inner.includes('@scope ([data-zarishnoksha-variant="1"])'), "variant-1 scope kept");
    assert.match(
      after,
      /\n {10}<div data-zarishnoksha-variant="1" style=\{\{ display: 'contents' \}\}>\n {12}<p className="hook">variant one<\/p>\n {10}<\/div>/,
  ...
  it("carbonize does not double-wrap when JSX template-literal punctuation hugs the CSS lines", () => {
    const tsx =
      ...
      `    <main>\n` +
      `      <>\n` +
      `        {/* zarishnoksha-variants-start INLINE */}\n` +
      `        <div data-zarishnoksha-variants="INLINE" data-zarishnoksha-variant-count="2" style={{ display: 'contents' }}>\n` +
      `          <div data-zarishnoksha-variant="original"><p className="hook">orig</p></div>\n` +
      `          <style data-zarishnoksha-css="INLINE">\n` +
      '            {`@scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }\n' +
      '             @scope ([data-zarishnoksha-variant="2"]) { .hook { color: green; } }`}\n' +
      `          </style>\n` +
      `          <div data-zarishnoksha-variant="1"><p className="hook">variant one</p></div>\n` +
      `          <div data-zarishnoksha-variant="2" style={{ display: 'none' }}><p className="hook">variant two</p></div>\n` +
      `        </div>\n` +
      `        {/* zarishnoksha-variants-end INLINE */}\n` +
      `      </>\n` +
      `    </main>\n` +
      `  );\n` +
      `}\n`;
    ...
    const after = readFileSync(join(tmp, "App.tsx"), "utf-8");
    const inner = after.match(/<style data-zarishnoksha-css="INLINE">([\s\S]*?)<\/style>/)[1];
    const openCount = (inner.match(/\{`/g) || []).length;
    const closeCount = (inner.match(/`\}/g) || []).length;
  ...
  it("carbonize preserves nested JSX indentation when the wrapper starts at column 0", () => {
    const tsx = `<div data-zarishnoksha-variants="ROOTIND" data-zarishnoksha-variant-count="2" style={{ display: 'contents' }}>
  {/* zarishnoksha-variants-start ROOTIND */}
  <div data-zarishnoksha-variant="original">
    <section className="hook">
      <span>original</span>
    </section>
  </div>
  <style data-zarishnoksha-css="ROOTIND">{\`@scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }\`}</style>
  <div data-zarishnoksha-variant="1">
    <section className="hook">
  ...
  {/* zarishnoksha-variants-end ROOTIND */}
</div>
`;
    ...
    assert.match(
      after,
      /<div data-zarishnoksha-variant="1" style=\{\{ display: 'contents' \}\}>\n {4}<section className="hook">\n {6}<span>nested text<\/span>\n {4}<\/section>\n {2}<\/div>/,
  ...
  return (
    ...
    // the outer wrapper, and no zarishnoksha markers/data attributes.
    assert.ok(!after.includes("data-zarishnoksha-variants"), `outer wrapper div must be fully removed; got:\n${after}`);
    assert.ok(
      !after.includes("data-zarishnoksha-variant"),
      `original-div wrapper must be fully removed; got:\n${after}`,
    );
    assert.ok(!after.includes("zarishnoksha-variants-start"), `start marker must be removed; got:\n${after}`);
    ...
    assert.ok(
      after.includes('<div className="next-card">After</div>'),
  ...
  return (
    <main>
      <div
        className="zarishnoksha-preview-shell"
${extraAttrs}
        data-zarishnoksha-variants="LONGOPEN"
        data-zarishnoksha-variant-count="2"
        style={{ display: 'contents' }}
      >
        {/* zarishnoksha-variants-start LONGOPEN */}
        {/* Original */}
        <div data-zarishnoksha-variant="original">
          <aside className="card">
            <h1>Original</h1>
        ...
        <div data-zarishnoksha-variant="1"><aside className="card"><h1>Variant</h1></aside></div>
        {/* zarishnoksha-variants-end LONGOPEN */}
      </div>
      <div className="next-card">After</div>
    </main>
  );
    ...
    const after = readFileSync(join(tmp, "App.tsx"), "utf-8");
    assert.doesNotMatch(after, /data-zarishnoksha-variants/);
    assert.doesNotMatch(after, /zarishnoksha-variants-start/);
  ...
  return (
    <main>
      <div data-zarishnoksha-variants="ACTIVE" data-zarishnoksha-variant-count="2" style={{ display: 'contents' }}>
        <div className="historical-marker-note">
          {/* zarishnoksha-variants-end OLD */}
        </div>
        {/* zarishnoksha-variants-start ACTIVE */}
        {/* Original */}
        <div data-zarishnoksha-variant="original">
          <aside className="card">
            <h1>Original</h1>
        ...
        {/* Variants: insert below this line */}
        <div data-zarishnoksha-variant="1"><aside className="card"><h1>Variant</h1></aside></div>
        {/* zarishnoksha-variants-end ACTIVE */}
      </div>
      <div className="next-card">After</div>
    </main>
  );
    ...
    const after = readFileSync(join(tmp, "App.tsx"), "utf-8");
    assert.doesNotMatch(after, /data-zarishnoksha-variants/);
    assert.doesNotMatch(after, /zarishnoksha-variants-start ACTIVE/);
    assert.doesNotMatch(after, /zarishnoksha-variants-end OLD/);
    assert.match(after, /<aside className="card">\s*<h1>Original<\/h1>\s*<\/aside>/m);
    assert.ok(after.includes('<div className="next-card">After</div>'));
  });
  ...
  return (
    <main>
      <div data-zarishnoksha-variants="INDENTACC" data-zarishnoksha-variant-count="3" style={{ display: "contents" }}>
        {/* zarishnoksha-variants-start INDENTACC */}
        {/* Original */}
        <div data-zarishnoksha-variant="original">
          <aside className="card">
            <h1 className="hero-title">Hero</h1>
        ...
        {/* Variants: insert below this line */}
        <div data-zarishnoksha-variant="1"><aside className="card variant-one"><h1 className="hero-title">Hero</h1></aside></div>
        {/* zarishnoksha-variants-end INDENTACC */}
      </div>
    </main>
  );
}`;
    ...
    assert.match(
      after,
      /^ {6}<aside className="card variant-one">/m,
  ...
  it("discard restores the original element after a JSX self-closing <style />", () => {
    const html = `<body>
  <!-- zarishnoksha-variants-start DISC -->
  <div data-zarishnoksha-variants="DISC" data-zarishnoksha-variant-count="2" style="display: contents">
    <div data-zarishnoksha-variant="original"><p class="hook">ORIGINAL CONTENT</p></div>
    <style data-zarishnoksha-css="DISC" dangerouslySetInnerHTML={{ __html: '@scope ([data-zarishnoksha-variant="1"]) { .hook { color: red; } }' }} />
    <div data-zarishnoksha-variant="1"><p class="hook">variant one</p></div>
    <div data-zarishnoksha-variant="2" style="display: none"><p class="hook">variant two</p></div>
  </div>
  <!-- zarishnoksha-variants-end DISC -->
</body>`;
    writeFileSync(join(tmp, "page.html"), html);
    ...
    assert.ok(!after.includes("zarishnoksha-variants-start"), "wrapper markers gone");
...
describe("live-accept — insert sessions", () => {
  let tmp;
  beforeEach(() => {
    tmp = mkdtempSync(join(tmpdir(), "zarishnoksha-accept-insert-"));
  });
  afterEach(() => {
    rmSync(tmp, { recursive: true, force: true });
  });
  ...
  <!-- zarishnoksha-variants-start ${id} -->
  <div data-zarishnoksha-variants="${id}" data-zarishnoksha-mode="insert" data-zarishnoksha-variant-count="2" style="display: contents">
    <!-- Variants: insert below this line -->
    <style data-zarishnoksha-css="${id}">@scope ([data-zarishnoksha-variant="1"]) { .cta { color: red; } }</style>
    <div data-zarishnoksha-variant="1"><p class="cta">Variant one</p></div>
    <div data-zarishnoksha-variant="2" style="display: none"><p class="cta">Variant two</p></div>
  </div>
  <!-- zarishnoksha-variants-end ${id} -->
  ...
  it("discard removes an insert wrapper without touching anchor sections", () => {
    ...
    assert.ok(!after.includes("zarishnoksha-variants-start"));
