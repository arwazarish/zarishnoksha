...
import { completionAckForAcceptResult, completionTypeForAcceptResult } from "../skill/scripts/live/completion.mjs";
...
describe("live completion type classification", () => {
  ...
  it("keeps normal handled accepts terminal", () => {
    assert.deepEqual(completionAckForAcceptResult("done-1", "complete", { handled: true, carbonize: false }), {
      ok: true,
      type: "complete",
    });
  });
