...
describe("zarishnoksha ignores CLI", () => {
  let root;
  ...
  function readConfig(name = "config.json") {
    return JSON.parse(readFileSync(join(root, ".zarishnoksha", name), "utf-8"));
  }
