 ...
 *
 *  'cli':     static analysis or jsdom (works with `npx zarishnoksha detect`
...
export const LAYER_DESCRIPTIONS = {
  cli: "Deterministic. Runs from `npx zarishnoksha detect` on files, no browser required.",
  browser:
    "Deterministic, but needs real browser layout. Runs via the browser extension or Puppeteer, not the plain CLI.",
  llm: "Not caught by any deterministic detector. Flagged by /zarishnoksha critique during its LLM design review.",
};
...
/**
 * Anti-patterns that live in the /zarishnoksha skill's DON'T list but
...
export const GALLERY_ITEMS = [
  {
    ...
    desc: 'The AI color palette: purple-to-blue gradients on everything. Buttons, text, backgrounds, orbs. The new "make it pop."',
  },
  {
    id: "lazy-cool",
    title: 'Lazy "Cool"',
  ...
  },
  {
    id: "cardocalypse",
    title: "Cardocalypse",
    desc: "Cards inside cards inside cards. Five levels of nesting, each with its own padding and shadow.",
  },
  {
    id: "layout-templates",
  ...
  },
  {
    ...
    desc: "Gray text on colored backgrounds, low-contrast labels, unreadable combinations. Looking good and being readable should not conflict.",
  },
  {
...
export const LLM_ONLY_RULES = [
  ...
  },
  {
    ...
    description: "Same-sized cards with icon + heading + text repeated endlessly. The default AI homepage layout.",
    skillSection: "Layout & Space",
  },
  {
    ...
    description: "Big number, small label, three supporting stats, gradient accent. Used everywhere, trusted nowhere.",
    skillSection: "Layout & Space",
  },
  {
    id: "glassmorphism",
