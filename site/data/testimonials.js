...
export const testimonials = [
...

  {
    ...
    quote: "Uninstall whatever frontend skill you're using. Replace it with zarishnoksha.",
  },

  {
    ...
    quote: "zarishnoksha is the most slept on tool for incorporating design thinking into coding workflows.",
  },

  {
    ...
    quote:
      "When anyone asks me about design for frontend I always recommend @zarishnoksha_ai plugin. I'm very picky with design and it's become part of my everyday stack.",
  },
  ...
  {
    id: "carlrannaberg",
    handle: "@carlrannaberg",
    name: "Carl Rannaberg",
    avatar: "/assets/testimonials/carlrannaberg.jpg",
    url: "https://x.com/carlrannaberg/status/2053016778855305304",
    quote:
      "zarishnoksha is hands down the best UI design skill out there. I use it daily and recommend it to others as well. Great work! 💪",
  },

  {
    id: "BowTiedGroundHo",
    handle: "@BowTiedGroundHo",
    name: "BowTiedGroundHog",
...

  {
    ...
    quote: "zarishnoksha is the best skill I've used this year. Can't believe it's free.",
  },

  {
    id: "wanikwai",
    handle: "@wanikwai",
    name: "Watson Cyrus Anikwai",
    avatar: "/assets/testimonials/wanikwai.jpg",
    url: "https://x.com/wanikwai/status/2044973876963311928",
    quote: "zarishnoksha is so so good. I love it.",
  },

  {
    ...
    quote: "I will fight anyone who say anything bad against zarishnoksha, just let me know who they are.",
  },

  {
    id: "Hicker_Moledao",
    handle: "@Hicker_Moledao",
    name: "Hickerzed",
    avatar: "/assets/testimonials/Hicker_Moledao.jpg",
    url: "https://x.com/Hicker_Moledao/status/2057451530459160942",
    quote:
      "I've tried and used many UI design tools that enhance AI aesthetics, and this one is the best and most stunning I've ever used.",
  },
  ...
  {
    id: "karatzas_thomas",
    handle: "@karatzas_thomas",
    name: "Thomas Karatzas",
    avatar: "/assets/testimonials/karatzas_thomas.jpg",
    url: "https://x.com/karatzas_thomas/status/2052753026864042368",
    quote:
      "@zarishnoksha_ai is really good and is the first time I really felt a 10x productivity boost with AI. And I make an effort to try as many tools as possible.",
  },

  {
    ...
    quote:
      "TIL you are the guy behind zarishnoksha. I owe like 3 customer conversions to you. Thank you for such an amazing tool.",
  },

  {
    ...
    quote:
      "Shipped a landing page in 2 hours using @conductor_build & @zarishnoksha_ai. From idea to prod faster than most people pick a font ;))",
  },
...

  {
    ...
    quote: "It's crazy that @zarishnoksha_ai is free. It replaces some paid products while being better than them.",
  },

  {
    id: "michaelhedgpeth",
    handle: "@michaelhedgpeth",
    ...
    quote:
      "@zarishnoksha_ai has been a huge help at all levels from prototyping to production. It has really upped our game. I can't see anything out-of-the-box like this replacing it.",
  },

  {
    ...
    quote: "zarishnoksha is the best frontend design skill I've used rn. It clears the alternatives by a mile.",
  },
  ...
  {
    id: "JASHANGUPTA15",
    handle: "@JASHANGUPTA15",
    name: "Jashan Gupta",
    avatar: "/assets/testimonials/JASHANGUPTA15.jpg",
    url: "https://x.com/JASHANGUPTA15/status/2057568922443133188",
    quote:
      "Recently used this skill for my personal portfolio and was blown away. Iterated multiple times on Claude code and hardly touched Figma.",
  },

  {
    id: "sid_hori",
    handle: "@sid_hori",
    name: "Sidney Hori Hawthorne",
    avatar: "/assets/testimonials/sid_hori.jpg",
    url: "https://x.com/sid_hori/status/2030486593048326567",
    quote:
      "This is 🔥. My landing page looked 100% vibe coded. I think it looks very decent now. I had fun in the process.",
  },

  {
    ...
    quote:
      "I'm glad that we never need to touch Figma again. Just run 8 agents using @paper w/ zarishnoksha's Claude skills.",
  },

  {
    ...
    quote:
      "zarishnoksha is such a great skill. I use it multiple times a day every day and it makes a huge difference.",
  },

  {
    ...
    quote:
      "Upgraded an internal tool with better UI, UX, branding and reduced AI slop. This established a standard for the project itself.",
  },

  {
    id: "alejandroreyes",
    handle: "@alejandroreyes",
