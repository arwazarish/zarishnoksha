...
```
/zarishnoksha onboard the editor
```
...
- **Designing onboarding without defining the aha moment.** If you cannot say in one sentence what the user should feel in the first 60 seconds, go back to `/zarishnoksha shape` first.
