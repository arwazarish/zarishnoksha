...
// Laser effect adapted from arwazarish/shaders laser-precision
...
export default {
  ...
  before: `
    <div style="width: 100%; height: 100%; min-height: 200px; display: flex; align-items: center; justify-content: center; background: #f5f5f5; font-family: system-ui, sans-serif;">
      <div style="text-align: center; padding: 20px;">
        <div style="font-size: 12px; color: #666; font-style: italic; line-height: 1.6; max-width: 220px; margin-bottom: 16px;">It's time to spark your imagination. Welcome to the ZarishNoksha Community.</div>
        <div style="font-size: 12px; color: #aaa;">Arwa Zarish ISLAM</div>
      </div>
    </div>
  `,
  ...
  after: `
    ...
    <div style="position: absolute; inset: 0; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px; pointer-events: none; text-align: center;">
      <p style="font-family: 'Cormorant Garamond', serif; font-size: 1.1rem; font-style: italic; font-weight: 400; color: rgba(240,230,210,0.85); line-height: 1.5; max-width: 260px; margin: 0 0 24px;">It's time to spark your imagination.<br>Welcome to the ZarishNoksha Community.</p>
    </div>
  `,
  ...
  init(container) {
    ...
    function draw(timestamp) {
      ...
      if (phase === "drawing" && drawnLength < strokeData[currentStroke].total) {
        ...
        sCtx.fillStyle = g0;
        sCtx.beginPath();
        sCtx.arc(tip.x, tip.y, 35, 0, Math.PI * 2);
        sCtx.fill();
        ...
        sCtx.fillStyle = g1;
        sCtx.beginPath();
        sCtx.arc(tip.x, tip.y, 16, 0, Math.PI * 2);
        sCtx.fill();
        ...
        sCtx.fillStyle = g2;
        sCtx.beginPath();
        sCtx.arc(tip.x, tip.y, 6, 0, Math.PI * 2);
        sCtx.fill();
        ...
        sCtx.fillStyle = g3;
        sCtx.beginPath();
        sCtx.arc(tip.x, tip.y, 2.5, 0, Math.PI * 2);
        sCtx.fill();
      }
