...
export const readySkills = [
  "zarishnoksha", // Consolidated skill with all design domains
];
...
export const alphaCommands = ["live"];

// Consolidated zarishnoksha skill with reference domains
...
export const slopFocusAreas = {
  zarishnoksha: [
    {
      area: "Typography",
      detail: "A type scale with real contrast, set in a face chosen on purpose, not Inter by reflex.",
    },
    {
      area: "Color & Contrast",
      detail: "Palettes that clear WCAG and commit to a hue. The purple-gradient default never ships.",
    },
    {
      area: "Spatial Design",
      detail: "Structure from spacing and rhythm, not a grid of identical cards nested in more cards.",
    },
    { area: "Responsive", detail: "Built for the small screen first, with breakpoints that follow the content." },
    {
      area: "Interaction",
      detail: "Honest states and clear affordances, without defaulting to a modal or gradient text.",
    },
...
// Reference domains within the zarishnoksha skill
...
export const commandProcessSteps = {
  zarishnoksha: ["Direct", "Design", "Build", "Refine"],
...
// Skill relationships - now consolidated into zarishnoksha skill
// The zarishnoksha skill contains all domains as reference files
...
export const commandRelationships = {
  zarishnoksha: { flow: "Create: Freeform design with full design intelligence" },
  ...
  critique: {
    leadsTo: ["polish", "distill", "bolder", "quieter", "typeset", "layout"],
    flow: "Evaluate: UX and design review with scoring",
  },
