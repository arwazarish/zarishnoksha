...
function printUsage() {
  console.log(`Usage: zarishnoksha detect [options] [file-or-dir-or-url...]
...
Options:
  ...
  --no-inline-ignores Do not honor in-file zarishnoksha-disable* ignore comments
  --no-design-system  Do not load local DESIGN.md / .zarishnoksha/design.json context
  --help              Show this help message

Project config:
  Respects .zarishnoksha/config.json and .zarishnoksha/config.local.json detector
...
Inline ignores:
  In-file comments waive a finding where it lives and travel with the file:
    ...
    // zarishnoksha-disable-next-line bounce-easing: intentional bounce
  zarishnoksha-disable applies to the whole file; -line / -next-line are scoped.
...
Examples:
  zarishnoksha detect src/
  zarishnoksha detect index.html
  zarishnoksha detect https://example.com
  zarishnoksha detect --json .
  zarishnoksha detect --no-config src/`);
}
...
async function detectCli() {
  ...
  // Inline `zarishnoksha-disable*` waivers are part of the scanned file, so they
              ...
              if (probe.listening && probe.matched) {
                process.stderr.write(
                  `\n${fwConfig.name} dev server detected on localhost:${fwConfig.port}.\n` +
                    ...
                    `  npx zarishnoksha detect http://localhost:${fwConfig.port}\n\n`,
                );
