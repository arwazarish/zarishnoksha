 ...
 *
 * On first live run, the agent generates `.zarishnoksha/live/config.json`
...
import { resolveLiveConfigPath } from "./lib/zarishnoksha-paths.mjs";
import {
...
const MARKER_OPEN_TEXT = "zarishnoksha-live-start";
const MARKER_CLOSE_TEXT = "zarishnoksha-live-end";
const IGNORE_MARKER_OPEN = "# zarishnoksha-live-ignore-start";
const IGNORE_MARKER_CLOSE = "# zarishnoksha-live-ignore-end";
...
export const LIVE_IGNORE_PATTERNS = Object.freeze([
  ...
  ".zarishnoksha/live/previews/",
  ".zarishnoksha/live/annotations/",
  ".zarishnoksha/live/cache/",
  ".zarishnoksha/live/manual-edit-apply-transaction.json",
  ".zarishnoksha/live/manual-edit-events.jsonl",
  ".zarishnoksha/live/manual-edit-evidence/",
  ".zarishnoksha/live/pending-manual-edits.json",
  ".zarishnoksha/live/deferred-svelte-component-accepts.json",
  ".zarishnoksha-live.json",
  ".zarishnoksha-live/",
  "node_modules/.zarishnoksha-live/",
  "src/lib/zarishnoksha/zarishnokshaLiveRoot.svelte",
  "src/lib/zarishnoksha/__runtime.js",
  "src/lib/zarishnoksha/[0-9a-f]*/",
]);
...
Reads configuration from .zarishnoksha/live/config.json.

Modes:
  --port PORT   Insert script tag pointing at http://localhost:PORT/live.js
  --remove      Remove the script tag (if present)
  --check       Print whether .zarishnoksha/live/config.json exists and its content
...
function removeTag(content, _syntax) {
  const patterns = [
    /([ \t]*)<!--\s*zarishnoksha-live-start\s*-->[\s\S]*?<!--\s*zarishnoksha-live-end\s*-->([ \t]*(?:\r\n|\n|\r|$)?)/,
    /([ \t]*)\{\/\*\s*zarishnoksha-live-start\s*\*\/\}[\s\S]*?\{\/\*\s*zarishnoksha-live-end\s*\*\/\}([ \t]*(?:\r\n|\n|\r|$)?)/,
  ];
  for (const pat of patterns) {
    let changed = false;
...
// and stash the original `content` value in a `data-zarishnoksha-csp-original`
...
const CSP_MARKER_ATTR = "data-zarishnoksha-csp-original";
