/**
 * Browser-side DOM helpers for zarishnoksha live mode.
 *
...
((root) => {
  ...
  function createLiveBrowserDomHelpers({
    ...
    function makeFrozenAnchor(el) {
      ...
      return {
        __zarishnokshaFrozenAnchor: true,
    ...
    function liveUiRoot() {
      const uiRoot = root.__zarishnoksha_LIVE_UI_ROOT__;
  ...
  root.__zarishnoksha_LIVE_DOM__ = {
    version: 1,
