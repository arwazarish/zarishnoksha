/**
 * CLI-side reader/writer for the unified `.zarishnoksha` config.
 *
...
export function getConfigPath(root) {
  return join(root, ".zarishnoksha", "config.json");
}

export function getLocalConfigPath(root) {
  return join(root, ".zarishnoksha", "config.local.json");
}
...
/**
 * Detector filters shared by `npx zarishnoksha detect` and the design hook.
...
const EXCLUDE_OPEN = "# zarishnoksha-config-ignore-start";
const EXCLUDE_CLOSE = "# zarishnoksha-config-ignore-end";
const EXCLUDE_PATTERNS = [".zarishnoksha/config.local.json"];
